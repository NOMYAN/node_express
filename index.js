...
app.get("/", (request, response)=>{     //listen for get request:http://127.0.0.1/, for the root of the app, callback function processes 
...
app.listen(PORT, HOST);                             //invoke the listen() method for app, listen to por:8080;
